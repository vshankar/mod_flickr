/*
 * License as per below.
 * Code modified to use apache memory management
 * routines for memory (de)allocation.
 */
...
/* my code from here */
/*
 * modified to work with apache's
 * memory allocation routines.
 */

char* MD5_string(apr_pool_t *p, char *string);

char*
MD5_string(apr_pool_t *p, char *string)
{
